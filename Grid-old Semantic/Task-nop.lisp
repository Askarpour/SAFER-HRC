...
; 					; 	)
; 					; )
; 					(yesterday (|| ([=] (-V- actions i 1) executing) ([=] (-V- actions i 1) pause)))
...
; 	            			(lasted_ie ([=] (-V- actions i 1) executing) 3)
		        ...
		        (->
	      		...
	      		(-> ;definition of done
	            		...
	            		(&&
	            			...
	            			;no pause within "exe_time" time units 
	            			; (!! (withinp_ie ([=] (-V- actions i 1) pause) 6))
	            			 ; (-> (!!([=] i 5)) (lasted_ie ([=] (-V- actions i 1) executing) 3))
	            			 (lasted_ee (!!([=] (-V- actions i 1) pause)) (+ 1 exetime))
	            			;NOTE::::////exetime must be instead of 3
	            		)
            		)
