 ...
 (eval`(&&
    (<->
        ...
        (&&
            ...
            (!!
                (||
                    ([=] (-V- ,(with-input-from-string (in (format nil "Body_Part_pos ~a" bodypart)) (loop for x = (read in nil nil) while x collect x))) L3)
                    ([=] (-V- ,(with-input-from-string (in (format nil "Body_Part_pos ~a" bodypart)) (loop for x = (read in nil nil) while x collect x))) L4)
                    ([=] (-V- ,(with-input-from-string (in (format nil "Body_Part_pos ~a" bodypart)) (loop for x = (read in nil nil) while x collect x))) L8)
    ;                 ;;ocluded area 
