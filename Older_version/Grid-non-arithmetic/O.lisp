...
<<<<<<< HEAD
		...
		(define-array Body_Part_pos body_indexes L_indexes) 
=======
		(define-tvar Body_Part_pos *int* *int*)
...
<<<<<<< HEAD
		(->
			...
			(|| (Body_Part_pos= i L_1) (Body_Part_pos= i L_2) (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_4_b) (Body_Part_pos= i L_7))
		)
		(->
			(-E- j body_indexes 	
			...
			(|| (Body_Part_pos= i L_1) (Body_Part_pos= i L_7) (Body_Part_pos= i L_2) (Body_Part_pos= i L_3_a) (Body_Part_pos= i L_3_b) (Body_Part_pos= i L_3_c) (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_4_b)
			)
		)
		(->
			(-E- j body_indexes 	
				(Body_Part_pos= j L_3_a)
			)
			
			(|| (Body_Part_pos= i L_3_a) (Body_Part_pos= i L_3_b)))

		(->
			(-E- j body_indexes 	

				(Body_Part_pos= j L_3_b)
			)
			
			(|| (Body_Part_pos= i L_3_a) (Body_Part_pos= i L_3_b) (Body_Part_pos= i L_3_c)))
		(->
			(-E- j body_indexes 	
				(Body_Part_pos= j L_3_c)
			)
			
			(|| (Body_Part_pos= i L_1) (Body_Part_pos= i L_2) (Body_Part_pos= i L_7) (Body_Part_pos= i L_3_b) (Body_Part_pos= i L_3_c))
			)
		(->
			(-E- j body_indexes 	

				(Body_Part_pos= j L_4_a)
			)
			
			(|| (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_4_b) (Body_Part_pos= i L_5_b)))
		(->
			(-E- j body_indexes 	
				(Body_Part_pos= j L_4_b)
			)
			
			(|| (Body_Part_pos= i L_1) (Body_Part_pos= i L_2) (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_4_b) (Body_Part_pos= i L_7)))
		(->
			(-E- j body_indexes 	
				(Body_Part_pos= j L_5_a)
			)
			
			(|| (Body_Part_pos= i L_5_a) (Body_Part_pos= i L_5_b)))
		(->
			(-E- j body_indexes 	

				(Body_Part_pos= j L_5_b)
			)
			
			(|| (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_5_a) (Body_Part_pos= i L_5_b)))
		(->
			(-E- j body_indexes 	
			...
			(!! (&&(Body_Part_pos= i L_1) (Body_Part_pos= i L_7))))
		(->
			(-E- j body_indexes 	
			...
			(|| (Body_Part_pos= i L_1) (Body_Part_pos= i L_2) (Body_Part_pos= i L_7) (Body_Part_pos= i L_4_a) (Body_Part_pos= i L_3_c)
				))
				)
			)
		)
